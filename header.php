...
<script src="https://unpkg.com/vue-router/dist/vue-router.js"></script>
      ...
      <body>
	        <div id="header-container">
						<div id="header-inner">
							<div id="headerleft"><a href="index.php"><img src="img/efinance-logo.png"/></a></div>
			        <div id="headernav">|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Financial Partner</div><!--headernav-->
							<div id="header-right">
									<a href="https://www.efinanceng.com"><div id="quote">Back Home</div></a>
							</div><!--header-right-->
						</div><!--header-inner-->
