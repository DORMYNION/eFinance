                    ...
                    <div class="row gy-gs">
                        <div class="col-12">
                            ...
                            <div class="invest-field form-group">
                                ...
                                <div class="form-control-group">
                                    <div class="form-info"><em class="icon ni ni-arrow-down">&nbsp;&nbsp;</em></div>
                                    <select class="form-control form-control-amount custom-select <?php echo e($errors->has('repayment_option') ? 'is-invalid' : ''); ?>" name="repayment_option" id="repayment_option" required>
                                        ...
                                        <?php $__currentLoopData = App\Loan::REPAYMENT_OPTION_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($user->payment_method === 'Paystack' && $key == 'Interest payable monthly and Principal at maturity'): ?>
                                                <option disabled value="<?php echo e($key); ?>" <?php echo e(old('repayment_option', '') === (string) $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                                <?php break; ?>
                                            <?php endif; ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('repayment_option', '') === (string) $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div><!-- .invest-field --> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/app/resources/views/user/loan/index.blade.php ENDPATH**/ ?>