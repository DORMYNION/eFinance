...
<div id="thecont">
    ...
    <div id="contright">
      ...
      <?php if($current_loan): ?>
        <?php if($current_loan->status === 'Pending'): ?>
            ...
            <div id="loaninfo"><?php echo e($current_loan->repayment_option); ?> </div>
        ...
        <?php elseif($current_loan->status === 'Awaiting Disbursment'): ?>
              ...
              <form action="<?php echo e(route('admin.loans.disburse', $current_loan->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
                  ...
                  <?php if($current_loan->repayment_option == 'Interest and Principal payable at maturity' ): ?>
                    <input type="hidden" name="start_date" value="<?php echo e(Carbon\Carbon::now()->addMonths($current_loan->loan_duration)->format('c')); ?>">   
                  <?php else: ?>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="required" for="loan_amount"><?php echo e(trans('cruds.loan.fields.loan_amount')); ?></label>
                                    ...
                                    <input class="form-control <?php echo e($errors->has('loan_amount') ? 'is-invalid' : ''); ?>" type="number" name="loan_amount" id="loan_amount" value="<?php echo e(old('loan_amount', $current_loan->loan_amount)); ?>" step="0.01" required>
    ...
    <script>
        ...
        <?php if($current_loan->repayment_option == 'Interest and Principal payable at maturity' ): ?>
          paystack_amount.value = <?php echo e($current_loan->total * 100); ?>;
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/app/resources/views/admin/users/show.blade.php ENDPATH**/ ?>