    ...
    <div class="nk-block-head nk-block-head-lg">
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h2 class="nk-block-title fw-normal">Welcome, <?php echo e($user->name); ?></h2>
                ...
                <div class="card card-bordered card-full">
                    <div class="nk-wg1">
                        ...
                        <div class="nk-wg1-action">
                            <a href="<?php echo e(route('user.profile')); ?>" class="link"><span>Manage Your Account</span> <em class="icon ni ni-chevron-right"></em></a>
                        </div>
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-md-6">
                <div class="card card-bordered card-full">
                    <div class="nk-wg1">
                        ...
                        <div class="nk-wg1-action">
                            <a href="<?php echo e(route('user.loan')); ?>" class="link"><span>My Loans</span> <em class="icon ni ni-chevron-right"></em></a>
                        </div>
                    </div>
                </div>
            </div><!-- .col -->
            ...
            <div class="card-inner card-inner-md">
                <div class="card-title-group">
                    ...
                    <div class="card-action">
                        <a href="<?php echo e(route('user.payment')); ?>" class="link link-sm">See All <em class="icon ni ni-chevron-right"></em></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/eFinance/resources/views/user/home.blade.php ENDPATH**/ ?>