...
<div id="imagearea">
  ...
  <div id="imageright">
    <?php if($customer->profile_image): ?>
        <a href="<?php echo e(url('storage/' . $customer->profile_image->id . '/' . $customer->profile_image->file_name)); ?>" target="_blank">
            <img class="img-fluid no-border" src="<?php echo e(url('storage/' . $customer->profile_image->id . '/' . $customer->profile_image->file_name)); ?>"  alt="<?php echo e($customer->name); ?> Profile Image">
        </a>
    <?php else: ?>
        <img class="img-fluid no-border" src="<?php echo e(asset('img/profile/default.jpeg')); ?>" alt="<?php echo e($customer->name); ?> Profile Image">
    <?php endif; ?>
...
<div id="thecont">
    ...
    <div id="contright">
      ...
      <?php if($current_loan->status === 'Pending'): ?>
        ...
        <div id="loanamount">NGN <?php echo e($current_loan->loan_amount); ?></div>
        ...
        <div id="loaninfo">NGN <?php echo e($current_loan->interest); ?></div>
  
        <div id="loanhead">Total Payback Amount</div>
        <div id="loaninfo">NGN <?php echo e($current_loan->total); ?></div><p>
            ...
            <table class="table table-responsive-sm">
              ...
              <tbody>
                ...
                <?php for($i = 0; $i < $current_loan->loan_duration; $i++): ?>
                  <tr>
                    <td><?php echo e(round($current_loan->total / $current_loan->loan_duration, 2)); ?></td>
                    <td><?php echo e(Carbon\Carbon::parse($current_loan->loanAmounts[0]->disbursed_date)->addMonths($i)->format('d-m-Y')); ?></td>
      ...
      <?php $__currentLoopData = $customer->userDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $customerDocument): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div id="itemhead2">Loan History</div><!--itemhead2-->
        ...
        <?php $__currentLoopData = $customer->userLoans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
...
<div class="row">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/eFinance/resources/views/admin/customers/show2.blade.php ENDPATH**/ ?>