<?php $__env->startSection('mainContent'); ?>
                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-head-sub"><a class="back-to" href="<?php echo e(route('user.loan')); ?>"><em class="icon ni ni-arrow-left"></em><span>My Loans</span></a></div>
                                            ...
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <?php
                                                        ...
                                                        // dd(date('M d, Y',$a));
                                                    ?>
                                                <p>Your loan will be due on <?php echo e(date('M d, Y',$a)); ?> <span class="text-primary"><em class="icon ni ni-info"></em></span></p>
                                                </div>
                                            </div>
                                            <div class="nk-block-head-content">
                                                ...
                                                <ul class="nk-block-tools justify-content-md-end g-4 flex-wrap">
                                                    ...
                                                    <li class="order-md-last">
                                                        <form method="POST" action="<?php echo e(route('user.payment.pay')); ?>" accept-charset="UTF-8" role="form">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="email"     value="<?php echo e($user->email); ?>"> 
                                                            <input type="hidden" name="amount"    value="<?php echo e(round($loan_amount->balance,2) * 100); ?>"> 
                                                    ...
                                                    <li>
                                                        <div class="nk-block-des">
                                                            ...
                                                            <h4 class="nk-block-title fw-normal">NGN <?php echo e(number_format($current_loan->loanAmounts[0]->balance, 2)); ?></h4>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                                        ...
                                                        <div class="card-inner">
                                                            ...
                                                            <div class="sp-plan-desc sp-plan-desc-mb">
                                                                ...
                                                                <ul class="row gx-1">
                                                                    ...
                                                                    <li class="col-sm-4">
                                                                        <p><span class="text-soft">Status</span> <?php echo e($loanRepayment->status); ?></td></p>
                                                                    </li>
                                                                </ul>
                                                                        ...
                                                                        <ul class="row gx-1">
                                                                            <li class="col-sm-6">
                                                                                ...
                                                                                <form method="POST" action="<?php echo e(route('user.payment.pay')); ?>" accept-charset="UTF-8" role="form">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <input type="hidden" name="email" value="<?php echo e($user->email); ?>">
                                                                                    <input type="hidden" name="amount" id="amount" value="<?php echo e(round($next_payment->amount, 2) * 100); ?> ">
                                                                                    <input type="hidden" name="quantity" value="1">
                                                                                    <input type="hidden" name="currency" value="NGN">
                                                                                    <input type="hidden" name="reference" value="<?php echo e(Paystack::genTranxRef()); ?>"> 
                                                                                    <input type="hidden" name="metadata" value="<?php echo e(json_encode($array = [
                                                            ...
                                                            <div class="card-inner">
                                                                    ...
                                                                    <div class="sp-plan-desc sp-plan-desc-mb">
                                                                        <?php if($last_payment === []): ?>
                                                                            <ul class="row gx-1">
                                                                                <li class="col-sm-8">
                                                                                    <span class="ff-italic text-soft">Paid at <?php echo e($last_payment->date); ?></span>
                                                                                </li>
                                                                                <li class="col-sm-4 sp-plan-amount">
                                                                                    <span class="amount">NGN <?php echo e($last_payment->amount); ?></span>
                                                                                </li>
                                                                            </ul>
                                                                        <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/eFinance/resources/views/user/loan/show.blade.php ENDPATH**/ ?>