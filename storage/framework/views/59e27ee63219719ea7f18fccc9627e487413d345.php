                    ...
                    <div class="col-md-4">
                        <div class="sp-plan-action card-inner">
                            ...
                            <div class="sp-plan-btn">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('user.loan.show')); ?>" value="Pay Now!">Pay Now!</a>
                                    
                                
                                </div>
                                
                                <div class="sp-plan-note text-md-center">
                                    <p class="mb-0">Due Date <span><?php echo e($current_loan->updated_at); ?></span></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/eFinance/resources/views/user/loan/index.blade.php ENDPATH**/ ?>